    ...
    return (
        <div className="container-fluid homepage-bg">
            <Col className='align-self-center'>
                <h1 className='text-center text-warning pt-3 pb-4'>WHAT EQUIPMENT ARE YOU USING?</h1>
                <Row>

                    <Col md={6}>
                        <Card className="bg-warning mx-3">
                            ...
                            <Card.Body className='text-center'>
                                ...
                                <Card.Text style={{fontFamily: 'Komika Title', fontSize: '1.5em'}}>
